...
for position in players:
    for round in roundBank:
        print(position)
        print(round)

# bankStatus = print(f'Player ' + str(players) + 'is starting this round with ' + str(roundBank) + 'in their round bank.')
# totalBankStatus = print(f'Player ' + str(players) + 'is starting this round with ' + str(totalBank) + 'in their total bank.')
roundPlay()
